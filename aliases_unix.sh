...
alias bsub_singr='bsub -Is -M 200000 -n 8 -W 24:00 -R "span[ptile=1]" "module load singularity; singularity shell ~/singr_latest.sif"'
alias bsub_singr_jr='bsub -Is -n 4 -W 24:00 -R "span[ptile=1]" "module load singularity; singularity shell ~/singr_latest.sif"'
