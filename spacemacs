...
values."
  (setq-default
   ...
   ;; installation feature and you                               ;;  have to explicitly list a layer 'jk' in the
   ;; variable `dotspacemacs-configuration-layers' to install it.
   ;; (default 'unused)
   dotspacemacs-enable-lazy-installation 'unused
   ;; If no n-nil then Spacemacs will ask for confirmation before installing
...
;; org agenda week view: span 10 days, starting 3 days prior to current day
